...
export async function onRequestGet({ request }) {
  ...
  <!-- team names -->
  <text x="348" y="540" font-family="system-ui,-apple-system,'Segoe UI',sans-serif" font-size="${homeSize}" font-weight="800" fill="#ffffff" text-anchor="middle">${escXml(home)}</text>
  <text x="932" y="540" font-family="system-ui,-apple-system,'Segoe UI',sans-serif" font-size="${awaySize}" font-weight="800" fill="#ffffff" text-anchor="middle">${escXml(away)}</text>
  ...
  <g filter="url(#softshadow)">
    <rect x="${pickX}" y="595" width="${pickWidth}" height="64" rx="32" fill="rgba(255,138,60,.10)" stroke="rgba(255,138,60,.5)" stroke-width="2"/>
